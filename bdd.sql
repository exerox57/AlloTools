...
--
-- Client: localhost
-- Généré le: Lun 28 Janvier 2013 à 14:31
...
--
-- Structure de la table `jml_assets`
--
...
(32, 24, 56, 57, 1, 'com_users.category.7', 'Non catégorisé', '{"core.create":[],"core.delete":[],"core.edit":[],"core.edit.state":[]}'),
...
(35, 27, 19, 20, 3, 'com_content.article.1', 'Allotools', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}');

-- --------------------------------------------------------

--
-- Structure de la table `jml_associations`
--
...
--
-- Structure de la table `jml_banners`
--
...
--
-- Structure de la table `jml_banner_clients`
--
...
--
-- Structure de la table `jml_banner_tracks`
--
...
--
-- Structure de la table `jml_categories`
--
...
--
-- Contenu de la table `jml_categories`
--
...
--
-- Structure de la table `jml_contact_details`
--
...
--
-- Structure de la table `jml_content`
--
...
--
-- Contenu de la table `jml_content`
--
...
(1, 35, 'Alloootooools', 'allotools', '', 'intro', 'full', 1, 0, 0, 2, '0000-00-00 00:00:00', 183, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-01-24 07:45:58', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 0, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', ''),
(2, 35, 'HelloTest', 'allotools', '', 'introTest', 'fullTest', 1, 0, 0, 2, '0000-00-00 00:00:00', 183, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2013-01-24 07:45:58', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":null,"urlatext":"","targeta":"","urlb":null,"urlbtext":"","targetb":"","urlc":null,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_intro":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, 0, '', '', 1, 0, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');

-- --------------------------------------------------------

--
-- Structure de la table `jml_content_frontpage`
--
...
--
-- Structure de la table `jml_content_rating`
--
...
--
-- Structure de la table `jml_core_log_searches`
--
...
--
-- Structure de la table `jml_extensions`
--
...
--
-- Contenu de la table `jml_extensions`
--
...
(603, 'French (fr-FR)', 'language', 'fr-FR', '', 1, 1, 0, 1, '{"legacy":false,"name":"French (fr-FR)","type":"language","creationDate":"9 oct 2012","author":"French translation team : joomla.fr","copyright":"Copyright (C) 2005 - 2012 Open Source Matters & Joomla.fr. All rights reserved.","authorEmail":"traduction@joomla.fr","authorUrl":"www.joomla.fr","version":"2.5.8.1","description":"French administrator language for Joomla 3.0","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(604, 'French (fr-FR)', 'language', 'fr-FR', '', 0, 1, 0, 1, '{"legacy":false,"name":"French (fr-FR)","type":"language","creationDate":"9 nov 2012","author":"French translation team : joomla.fr","copyright":"Copyright (C) 2005 - 2012 Open Source Matters & joomla.fr. All rights reserved.","authorEmail":"traduction@joomla.fr","authorUrl":"www.joomla.fr","version":"2.5.8.1","description":"French site language for Joomla 3.0","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(605, 'TinyMCE langue FR', 'file', 'TinyMCE_fr-FR', '', 0, 1, 0, 1, '{"legacy":false,"name":"TinyMCE langue FR","type":"file","creationDate":"9 nov 2012","author":"French translation team : joomla.fr","copyright":"(C) 2005-2012 French Translation Team","authorEmail":"traduction@joomla.fr","authorUrl":"www.joomla.fr","version":"3.5.4.1","description":"\\t\\t\\n\\t\\t<h3>Installation du pack de langue FR de TinyMCE 3.5.4.1 pour Joomla 2.5 effectu\\u00e9e avec succ\\u00e8s<\\/h3>\\n \\u00a0 \\u00a0 \\u00a0 \\u00a0<div style=\\"font-weight:normal\\">\\n \\t\\tN''oubliez pas de s\\u00e9lectionner la langue FR dans la \\n \\t\\t<a href=\\"index.php?option=com_plugins&view=plugins&filter_search=TinyMCE\\"><strong>gestion du plug-in TinyMCE<\\/strong><\\/a><br \\/>\\n \\t\\tSi vous utilisez la d\\u00e9tection automatique, veillez \\u00e0 ce que soient install\\u00e9s les diff\\u00e9rents packs de langue de TinyMCE correspondants \\n \\t\\t\\u00e0 ceux install\\u00e9s pour Joomla!<\\/div>\\t\\t\\n\\t\\t\\n\\t","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Structure de la table `jml_finder_filters`
--
...
--
-- Structure de la table `jml_finder_links`
--
...
--
-- Structure de la table `jml_finder_links_terms0`
--
...
--
-- Structure de la table `jml_finder_links_terms1`
--
...
--
-- Structure de la table `jml_finder_links_terms2`
--
...
--
-- Structure de la table `jml_finder_links_terms3`
--
...
--
-- Structure de la table `jml_finder_links_terms4`
--
...
--
-- Structure de la table `jml_finder_links_terms5`
--
...
--
-- Structure de la table `jml_finder_links_terms6`
--
...
--
-- Structure de la table `jml_finder_links_terms7`
--
...
--
-- Structure de la table `jml_finder_links_terms8`
--
...
--
-- Structure de la table `jml_finder_links_terms9`
--
...
--
-- Structure de la table `jml_finder_links_termsa`
--
...
--
-- Structure de la table `jml_finder_links_termsb`
--
...
--
-- Structure de la table `jml_finder_links_termsc`
--
...
--
-- Structure de la table `jml_finder_links_termsd`
--
...
--
-- Structure de la table `jml_finder_links_termse`
--
...
--
-- Structure de la table `jml_finder_links_termsf`
--
...
--
-- Structure de la table `jml_finder_taxonomy`
--
...
--
-- Contenu de la table `jml_finder_taxonomy`
--
...
--
-- Structure de la table `jml_finder_taxonomy_map`
--
...
--
-- Structure de la table `jml_finder_terms`
--
...
--
-- Structure de la table `jml_finder_terms_common`
--
...
--
-- Contenu de la table `jml_finder_terms_common`
--
...
--
-- Structure de la table `jml_finder_tokens`
--
...
--
-- Structure de la table `jml_finder_tokens_aggregate`
--
...
--
-- Structure de la table `jml_finder_types`
--
...
--
-- Structure de la table `jml_languages`
--
...
--
-- Contenu de la table `jml_languages`
--
...
--
-- Structure de la table `jml_menu`
--
...
(1, 'menu', 'Menu_Item_Root', 'root', '', '', '', '', 1, 0, 0, 0, 0, 0, '0000-00-00 00:00:00', 0, 0, '', 1, '', 0, 45, 0, '*', 0),
(2, 'menu', 'com_banners', 'Banners', '', 'Banners', 'index.php?option=com_banners', 'component', 0, 1, 1, 4, 0, 0, '0000-00-00 00:00:00', 0, 0, 'class:banners', 2, '', 1, 10, 0, '*', 1),
...
--
-- Structure de la table `jml_menu_types`
--
...
--
-- Contenu de la table `jml_menu_types`
--
...
--
-- Structure de la table `jml_messages`
--
...
--
-- Structure de la table `jml_messages_cfg`
--
...
--
-- Structure de la table `jml_modules`
--
...
--
-- Contenu de la table `jml_modules`
--
...
--
-- Structure de la table `jml_modules_menu`
--
...
--
-- Contenu de la table `jml_modules_menu`
--
...
--
-- Structure de la table `jml_newsfeeds`
--
...
--
-- Structure de la table `jml_overrider`
--
...
--
-- Structure de la table `jml_redirect_links`
--
...
--
-- Structure de la table `jml_schemas`
--
...
--
-- Contenu de la table `jml_schemas`
--
...
--
-- Structure de la table `jml_session`
--
...
--
-- Contenu de la table `jml_session`
--

INSERT INTO `jml_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('42dpvv7soks9e5r5coe64bn3q0', 1, 0, '1359057325', '__default|a:8:{s:15:"session.counter";i:5;s:19:"session.timer.start";i:1359057312;s:18:"session.timer.last";i:1359057322;s:17:"session.timer.now";i:1359057324;s:22:"session.client.browser";s:108:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1312.52 Safari/537.17";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":2:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:1;s:2:"id";s:3:"183";s:4:"name";s:10:"Super User";s:8:"username";s:5:"admin";s:5:"email";s:15:"admin@admin.com";s:8:"password";s:65:"ffb4f623f521c4f438f7a2adbef9c365:S7agw2131vqypbJd5Y6ExkfoZvX0xYdf";s:14:"password_clear";s:0:"";s:8:"usertype";s:10:"deprecated";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2013-01-21 15:34:00";s:13:"lastvisitDate";s:19:"2013-01-24 08:22:28";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\0*\0_authLevels";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"a3c51d7f615ee4c5caca07ef13f405fb";}', 183, 'admin', ''),
('q1u9opefr2rvi8hucstd9tmdf7', 0, 1, '1359057299', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1359057298;s:18:"session.timer.last";i:1359057298;s:17:"session.timer.now";i:1359057298;s:22:"session.client.browser";s:108:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1312.52 Safari/537.17";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"b4b24fbee68ed7e18ed8e0a3476bb669";}', 0, '', '');

-- --------------------------------------------------------

--
-- Structure de la table `jml_template_styles`
--
...
--
-- Contenu de la table `jml_template_styles`
--
...
--
-- Structure de la table `jml_updates`
--
...
--
-- Contenu de la table `jml_updates`
--
...
(7, 3, 0, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '2.5.8.2', '', 'http://update.joomla.org/language/details/it-IT_details.xml', ''),
...
--
-- Structure de la table `jml_update_categories`
--
...
--
-- Structure de la table `jml_update_sites`
--
...
--
-- Contenu de la table `jml_update_sites`
--

INSERT INTO `jml_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 0, 1359013492),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 0, 1359013492),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist.xml', 0, 1359013492),
(4, 'French Language Pack Updates', 'collection', 'http://update.joomla.fr/translationlist.xml', 0, 1359013492);

-- --------------------------------------------------------

--
-- Structure de la table `jml_update_sites_extensions`
--
...
--
-- Contenu de la table `jml_update_sites_extensions`
--
...
--
-- Structure de la table `jml_usergroups`
--
...
--
-- Contenu de la table `jml_usergroups`
--
...
--
-- Structure de la table `jml_users`
--
...
(183, 'Super User', 'admin', 'admin@admin.com', 'ffb4f623f521c4f438f7a2adbef9c365:S7agw2131vqypbJd5Y6ExkfoZvX0xYdf', 'deprecated', 0, 1, '2013-01-21 15:34:00', '2013-01-24 19:55:19', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Structure de la table `jml_user_notes`
--
...
--
-- Structure de la table `jml_user_profiles`
--
...
--
-- Structure de la table `jml_user_usergroup_map`
--
...
--
-- Contenu de la table `jml_user_usergroup_map`
--
...
--
-- Structure de la table `jml_viewlevels`
--
...
--
-- Contenu de la table `jml_viewlevels`
--
...
--
-- Structure de la table `jml_weblinks`
--
...
--
-- Structure de la table `t_assets`
--
...
--
-- Contenu de la table `t_assets`
--

INSERT INTO `t_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
--
-- Structure de la table `t_associations`
--

CREATE TABLE IF NOT EXISTS `t_associations` (
  `id` varchar(50) NOT NULL COMMENT 'A reference to the associated item.',
  `context` varchar(50) NOT NULL COMMENT 'The context of the associated item.',
  `key` char(32) NOT NULL COMMENT 'The key for the association computed from an md5 on associated ids.',
  PRIMARY KEY (`context`,`id`),
...
--
-- Structure de la table `t_banners`
--
...
--
-- Structure de la table `t_banner_clients`
--

CREATE TABLE IF NOT EXISTS `t_banner_clients` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL DEFAULT '',
  `contact` varchar(255) NOT NULL DEFAULT '',
  `email` varchar(255) NOT NULL DEFAULT '',
...
--
-- Structure de la table `t_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `t_banner_tracks` (
  `track_date` datetime NOT NULL,
  `track_type` int(10) unsigned NOT NULL,
  `banner_id` int(10) unsigned NOT NULL,
  `count` int(10) unsigned NOT NULL DEFAULT '0',
...
INSERT INTO `t_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`) VALUES
(1, 0, 0, 0, 13, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '', 0, '2009-10-18 16:07:09', 0, '0000-00-00 00:00:00', 0, '*'),
(2, 27, 1, 1, 2, 1, 'non-categorise', 'com_content', 'Non catégorisé', 'non-categorise', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 42, '2010-06-28 13:26:37', 0, '0000-00-00 00:00:00', 0, '*'),
(3, 28, 1, 3, 4, 1, 'non-categorise', 'com_banners', 'Non catégorisé', 'non-categorise', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":"","foobar":""}', '', '', '{"page_title":"","author":"","robots":""}', 42, '2010-06-28 13:27:35', 0, '0000-00-00 00:00:00', 0, '*'),
(4, 29, 1, 5, 6, 1, 'non-categorise', 'com_contact', 'Non catégorisé', 'non-categorise', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{"target":"","image":""}', '', '', '{"page_title":"","author":"","robots":""}', 42, '2010-06-28 13:27:57', 0, '0000-00-00 00:00:00', 0, '*'),
...
--
-- Structure de la table `t_contact_details`
--
...
--
-- Structure de la table `t_content`
--
...
--
-- Structure de la table `t_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `t_content_frontpage` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `ordering` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`content_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Structure de la table `t_content_rating`
--

CREATE TABLE IF NOT EXISTS `t_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
  `rating_sum` int(10) unsigned NOT NULL DEFAULT '0',
  `rating_count` int(10) unsigned NOT NULL DEFAULT '0',
  `lastip` varchar(50) NOT NULL DEFAULT '',
...
--
-- Structure de la table `t_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `t_core_log_searches` (
  `search_term` varchar(128) NOT NULL DEFAULT '',
  `hits` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Structure de la table `t_extensions`
--

CREATE TABLE IF NOT EXISTS `t_extensions` (
  `extension_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `type` varchar(20) NOT NULL,
  `element` varchar(100) NOT NULL,
...
--
-- Contenu de la table `t_extensions`
--

INSERT INTO `t_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
(1, 'com_mailto', 'component', 'com_mailto', '', 0, 1, 1, 1, '{"legacy":false,"name":"com_mailto","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_MAILTO_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(2, 'com_wrapper', 'component', 'com_wrapper', '', 0, 1, 1, 1, '{"legacy":false,"name":"com_wrapper","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_WRAPPER_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(3, 'com_admin', 'component', 'com_admin', '', 1, 1, 1, 1, '{"legacy":false,"name":"com_admin","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_ADMIN_XML_DESCRIPTION","group":""}', '', '', '', 0, '0000-00-00 00:00:00', 0, 0),
(4, 'com_banners', 'component', 'com_banners', '', 1, 1, 1, 0, '{"legacy":false,"name":"com_banners","type":"component","creationDate":"April 2006","author":"Joomla! Project","copyright":"(C) 2005 - 2012 Open Source Matters. All rights reserved.\\n\\t","authorEmail":"admin@joomla.org","authorUrl":"www.joomla.org","version":"2.5.0","description":"COM_BANNERS_XML_DESCRIPTION","group":""}', '{"purchase_type":"3","track_impressions":"0","track_clicks":"0","metakey_prefix":""}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Structure de la table `t_finder_filters`
--

CREATE TABLE IF NOT EXISTS `t_finder_filters` (
  `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `alias` varchar(255) NOT NULL,
  `state` tinyint(1) NOT NULL DEFAULT '1',
...
--
-- Structure de la table `t_finder_links`
--

CREATE TABLE IF NOT EXISTS `t_finder_links` (
  `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `url` varchar(255) NOT NULL,
  `route` varchar(255) NOT NULL,
  `title` varchar(255) DEFAULT NULL,
...
--
-- Structure de la table `t_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `t_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`term_id`),
...
--
-- Structure de la table `t_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `t_finder_taxonomy` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
  `state` tinyint(1) unsigned NOT NULL DEFAULT '1',
...
--
-- Contenu de la table `t_finder_taxonomy`
--

INSERT INTO `t_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Structure de la table `t_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `t_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
  `node_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`link_id`,`node_id`),
  KEY `link_id` (`link_id`),
...
--
-- Structure de la table `t_finder_terms`
--

CREATE TABLE IF NOT EXISTS `t_finder_terms` (
  `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Structure de la table `t_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `t_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL,
  KEY `idx_word_lang` (`term`,`language`),
  KEY `idx_lang` (`language`)
...
--
-- Contenu de la table `t_finder_terms_common`
--

INSERT INTO `t_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Structure de la table `t_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `t_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Structure de la table `t_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `t_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
  `map_suffix` char(1) NOT NULL,
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
...
--
-- Structure de la table `t_finder_types`
--

CREATE TABLE IF NOT EXISTS `t_finder_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(100) NOT NULL,
  `mime` varchar(100) NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `t_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 0, 1),
(2, 'fr-FR', 'Français (FR)', 'Français (FR)', 'fr', 'fr', '', '', '', '', 1, 0, 2);
...
INSERT INTO `t_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `ordering`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Structure de la table `t_menu_types`
--

CREATE TABLE IF NOT EXISTS `t_menu_types` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `menutype` varchar(24) NOT NULL,
  `title` varchar(48) NOT NULL,
  `description` varchar(255) NOT NULL DEFAULT '',
...
--
-- Contenu de la table `t_menu_types`
--

INSERT INTO `t_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Menu principal', 'Le menu principal du site');
...
--
-- Structure de la table `t_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `t_messages_cfg` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `cfg_name` varchar(100) NOT NULL DEFAULT '',
  `cfg_value` varchar(255) NOT NULL DEFAULT '',
  UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`)
...
INSERT INTO `t_modules` (`id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 'Menu principal', '', '', 1, 'position-7', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu","startLevel":"0","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":"","window_open":"","layout":"","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid"}', 0, '*'),
(2, 'Identification', '', '', 1, 'login', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_login', 1, 1, '', 1, '*'),
(3, 'Articles populaires', '', '', 3, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_popular', 3, 1, '{"count":"5","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
(4, 'Articles les plus récents', '', '', 4, 'cpanel', 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_latest', 3, 1, '{"count":"5","ordering":"c_dsc","catid":"","user_id":"0","layout":"_:default","moduleclass_sfx":"","cache":"0","automatic_title":"1"}', 1, '*'),
...
--
-- Structure de la table `t_modules_menu`
--

CREATE TABLE IF NOT EXISTS `t_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`moduleid`,`menuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Contenu de la table `t_modules_menu`
--

INSERT INTO `t_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Structure de la table `t_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `t_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Structure de la table `t_overrider`
--

CREATE TABLE IF NOT EXISTS `t_overrider` (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `constant` varchar(255) NOT NULL,
  `string` text NOT NULL,
  `file` varchar(255) NOT NULL,
...
--
-- Structure de la table `t_redirect_links`
--

CREATE TABLE IF NOT EXISTS `t_redirect_links` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `old_url` varchar(255) NOT NULL,
  `new_url` varchar(255) NOT NULL,
  `referer` varchar(150) NOT NULL,
...
--
-- Structure de la table `t_schemas`
--

CREATE TABLE IF NOT EXISTS `t_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL,
  PRIMARY KEY (`extension_id`,`version_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Contenu de la table `t_schemas`
--

INSERT INTO `t_schemas` (`extension_id`, `version_id`) VALUES
(700, '2.5.8');
...
--
-- Contenu de la table `t_session`
--

INSERT INTO `t_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`, `usertype`) VALUES
('3f72c3805a3711792201961daf7e235c', 0, 1, '1358770724', '__default|a:5:{s:22:"session.client.browser";s:108:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1312.52 Safari/537.17";s:15:"session.counter";i:1;s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";a:1:{i:0;i:1;}s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"982c912ee61e812b80bd1229eaa08fcf";}', 0, '', ''),
('8gmf9obockgfks94k1f4vuaj14', 1, 1, '1358772484', '__default|a:8:{s:15:"session.counter";i:9;s:19:"session.timer.start";i:1358770728;s:18:"session.timer.last";i:1358771644;s:17:"session.timer.now";i:1358772484;s:22:"session.client.browser";s:108:"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.17 (KHTML, like Gecko) Chrome/24.0.1312.52 Safari/537.17";s:8:"registry";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":1:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:0:"";}}}s:4:"user";O:5:"JUser":25:{s:9:"\0*\0isRoot";N;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:8:"usertype";N;s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:0:{}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\0*\0_params";O:9:"JRegistry":1:{s:7:"\0*\0data";O:8:"stdClass":0:{}}s:14:"\0*\0_authGroups";N;s:14:"\0*\0_authLevels";a:2:{i:0;i:1;i:1;i:1;}s:15:"\0*\0_authActions";N;s:12:"\0*\0_errorMsg";N;s:10:"\0*\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"5de7d335f3abd24707d57a743ef6b128";}', 0, '', '');

-- --------------------------------------------------------

--
-- Structure de la table `t_template_styles`
--

CREATE TABLE IF NOT EXISTS `t_template_styles` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `template` varchar(50) NOT NULL DEFAULT '',
  `client_id` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `home` char(7) NOT NULL DEFAULT '0',
...
--
-- Contenu de la table `t_template_styles`
--

INSERT INTO `t_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(2, 'bluestork', 1, '1', 'Bluestork - Default', '{"useRoundedCorners":"1","showSiteName":"0"}'),
(3, 'atomic', 0, '0', 'Atomic - Default', '{}'),
(4, 'beez_20', 0, '1', 'Beez2 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
...
--
-- Structure de la table `t_updates`
--
...
--
-- Structure de la table `t_update_categories`
--

CREATE TABLE IF NOT EXISTS `t_update_categories` (
  `categoryid` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) DEFAULT '',
  `description` text NOT NULL,
  `parent` int(11) DEFAULT '0',
...
--
-- Structure de la table `t_update_sites`
--

CREATE TABLE IF NOT EXISTS `t_update_sites` (
  `update_site_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) DEFAULT '',
  `type` varchar(20) DEFAULT '',
  `location` text NOT NULL,
...
--
-- Contenu de la table `t_update_sites`
--

INSERT INTO `t_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`) VALUES
...
--
-- Structure de la table `t_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `t_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`update_site_id`,`extension_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';
...
--
-- Contenu de la table `t_update_sites_extensions`
--

INSERT INTO `t_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 602);
...
--
-- Structure de la table `t_usergroups`
--
...
--
-- Contenu de la table `t_usergroups`
--

INSERT INTO `t_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 20, 'Public'),
(2, 1, 6, 17, 'Enregistré'),
(3, 2, 7, 14, 'Auteur'),
(4, 3, 8, 11, 'Rédacteur'),
...
INSERT INTO `t_users` (`id`, `name`, `username`, `email`, `password`, `usertype`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`) VALUES
(646, 'Super User', 'admin', 'ludovic.koziol@gmail.com', 'bdd8f7c3497a5d579c46d145ad3c7459:h3cIch1ZaKwdZJWWRNqkriOfIGQ5o3dX', 'deprecated', 0, 1, '2013-01-18 18:02:57', '0000-00-00 00:00:00', '0', '', '0000-00-00 00:00:00', 0);

-- --------------------------------------------------------

--
-- Structure de la table `t_user_notes`
--

CREATE TABLE IF NOT EXISTS `t_user_notes` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
  `subject` varchar(100) NOT NULL DEFAULT '',
...
--
-- Structure de la table `t_user_profiles`
--
...
--
-- Structure de la table `t_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `t_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id',
  PRIMARY KEY (`user_id`,`group_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Contenu de la table `t_user_usergroup_map`
--

INSERT INTO `t_user_usergroup_map` (`user_id`, `group_id`) VALUES
(646, 8);

-- --------------------------------------------------------

--
-- Structure de la table `t_viewlevels`
--

CREATE TABLE IF NOT EXISTS `t_viewlevels` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Contenu de la table `t_viewlevels`
--

INSERT INTO `t_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Accès Public', 0, '[1]'),
(2, 'Accès Enregistré', 1, '[6,2,8]'),
(3, 'Accès Spécial', 2, '[6,3,8]');
...
--
-- Structure de la table `t_weblinks`
--

CREATE TABLE IF NOT EXISTS `t_weblinks` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `catid` int(11) NOT NULL DEFAULT '0',
  `sid` int(11) NOT NULL DEFAULT '0',
  `title` varchar(250) NOT NULL DEFAULT '',
